          ...
          <ul>
            ...
            <li class="sm">
              <mu-list>
                ...
                <mu-list-item v-if="this.$store.getters.userInfo.openDiscounts" class="list sm" :title="!discountObj? '整单优惠' : discountObj.Type === 1 ? '整单折扣' : '整单减价'" :afterText="!discountObj? '无' : discountObj.Type === 1 ? discountObj.Value * 10 + `折(-￥${fullOrderActivit})` : '-'+ discountObj.Value +'元'"></mu-list-item>
